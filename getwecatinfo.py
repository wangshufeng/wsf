...
def main():
    ...
    writer.writerow(['username','name', 'city', 'male', 'star', 'signature', 'remark', 'alias', 'nick'])
...
#        wechataccount = 'wechataccount' if wechataccount == '' else  wechataccount
        ...
        print(name, '  ^+*+^  ', city, '  ^+*+^  ', Member['Sex'], ' ^+*+^ ', Member['StarFriend'], ' ^+*+^ ', sign,
              ' ^+*+^ ', remark, ' ^+*+^ ', alias, ' ^+*+^ ', nick)
        # 写入csv
        writer.writerow([username.encode('gbk', 'ignore').decode('gbk'),name.encode('gbk', 'ignore').decode('gbk'), city.encode('gbk', 'ignore').decode('gbk'),
                         Member['Sex'],
